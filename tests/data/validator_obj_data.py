...
BASIC_INFO_2 = ValidateBasicData({'model': 'ALFA ROMEO', 'price': 200, 'mileage': '2000'})
ENGINE_INFO_2 = ValidateEngineData({'engine': {'type': 'DIESEL', 'power': 150}})
...
ENGINE_INFO_3 = ValidateEngineData({'engine': {'type': 'DIESEL', 'power': 150.0}})
...
ENGINE_INFO_4 = ValidateEngineData({'engine': {'type': 'PETROL', 'power': 350.0}})
